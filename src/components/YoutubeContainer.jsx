...
const YoutubeContainer = ({query}) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await axios.request(youtubeOptions(query+"exercise"));
  ...
  return (
    ...
    <Container my="10" maxW={"container.lg"}>
        ...
        <Heading color="#435B66" fontFamily={"poppins"} textTransform={"capitalize"} my={5}>{query } Tutorial's</Heading>
